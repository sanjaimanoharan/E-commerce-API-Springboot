    ...
    public void run(String... args) throws Exception {
        ...
        if (productRepository.count() == 0) {
            ...
            List<Product> products = Arrays.asList(
                ...
                new Product("Campus Men's Maxico Running Shoes", 10.12, "The high raised back cover with extra padding.", 3, "Sports", "Ebay", 6, 9, Arrays.asList("https://picsum.photos/200/300", "https://picsum.photos/200/300")) // Missing comma added here
            );

            // Save products to the repository
            productRepository.saveAll(products);
            System.out.println("Demo data seeder");     }
    }
}
